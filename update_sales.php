                ...
                <div class="content-module">
                    ...
                    <div class="content-module-main cf">
                        ...
                        <?php
                            ...
                            $line = $db->ObjectBuilder()->rawQueryOne("SELECT * FROM stock_sales WHERE id=".$id);
                            ?>
                        <form name="form1" method="post" id="form1" action="">
                            ...
                            <table class="form" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <?php
                            $max = $db->getValue ("stock_sales", "count(transactionid)");
                            $max = $max + 1;
                            $autoid = "SL" . $max . "";
                            ?>
                                    <td>Bill no:</td>
                                    <td><input name="stockid" type="text" id="stockid" readonly="readonly"
                                            maxlength="200" class="round default-width-input" style="width:130px "
                                            value="<?php echo $line->transactionid; ?>" /></td>

                                    <td>Date:</td>
                                    <td><input name="date" id="test1" placeholder="" value="<?php echo $line->date; ?> "
                                            style="margin-left: 15px;" type="text" id="name" maxlength="200"
                                ...
                                <tr>
                                    ...
                                    <td>Address:</td>
                                    <td><input name="address" placeholder="ENTER ADDRESS" type="text" value="<?php $address = $db->ObjectBuilder()->rawQueryOne("SELECT customer_address,customer_contact1 FROM customer_details WHERE customer_name='$line->customer_id'");
                                    ...
                                    <td><input name="contact" placeholder="ENTER CONTACT" type="text"
                                            value="<?php echo $address->customer_contact1 ?>" id="contact1"
                            ...
                            <div style="overflow:auto ;max-height:300px;  ">
                                <table class="form" id="item_copy_final">
                                    ...
                                    $db->where ('transactionid', $sid);
                                    $max = $db->getValue ("stock_sales", "count(count1)");
                                    for ($i = 1; $i <= $max; $i++) {
                                        $line1 = $db->ObjectBuilder()->rawQueryOne("SELECT * FROM stock_sales WHERE transactionid ='$sid' and count1='$i'");

                                        $item = $db->rawQueryValue("SELECT transactionid  FROM stock_sales WHERE stock_name='" . $line1->stock_name . "' limit 1");
                                    ?>

                                    <tr>

                                        <td><input name="stock_name[]" type="text" id="<?php echo $item . "st" ?>"
                                                maxlength="20" style="width: 150px" readonly="readonly" class="round "
                                        ...
                                        <td><input name="stock[]" type="text" id="<?php echo $item . "p" ?>"
                                                ...
                                                value="<?php $quantity = $db->rawQueryValue("SELECT quantity FROM stock_avail WHERE name='$line1->stock_name' limit 1"); echo $quantity;?>" />
                                        </td>

                                        <td><input name="total[]" type="text" id="<?php echo $item . "to" ?>"
                                                readonly="readonly" maxlength="20" style="margin-left:20px;width: 120px"
                                                class="round " value="<?php echo $line1->amount; ?>" /></td>
                                        ...
                                        <td><input type="hidden" id="<?php echo $item; ?>"><input type="hidden"
                                                name="gu_id[]" value="<?php echo $line1->id ?>">
                                        </td>
                            ...
                            <table class="form">
                                ...
                                <tr>
                                    <td> &nbsp;</td>
                                    <td> &nbsp;</td>
                                    <td><input type="checkbox" id="round" onclick="discount_type()">Discount As Amount
                                    </td>
                                </tr>
                                <tr>
                                    <td> &nbsp;</td>
                                    <td>Discount %<input type="text" maxlength="3"
                                            value="<?php echo $line->discount; ?>" class="round" onkeyup=" discount_amount();
                                    ...
                                    <td>Discount Amount:<input type="text" readonly="readonly"
                                            ...
                                            onkeypress="return numbersonly(event);" onkeyup=" discount_as_amount();
                                                                           " class="round" id="disacount_amount"
                                            name="dis_amount">
                                    </td>
                                    <td> &nbsp;</td>
                                    <td> &nbsp;</td>
                                    ...
                                    <td>Grand Total:<input type="hidden" readonly="readonly"
                                            value="<?php echo $line->grand_total; ?>" id="grand_total" name="subtotal">
                                ...
                                <tr>
                                    ...
                                    <td> Tax:<input type="text" name="tax" value="<?php echo $line->tax ?>"
                                            onkeypress="return numbersonly(event);"></td>
                                    <td>Tax Description:<input type="text" <?php echo $line->tax_dis ?> name="tax_dis">
                                    </td>
                                    <td> &nbsp;</td>
                                    <td> &nbsp;</td>
                                    <td> &nbsp;</td>
